...
<html>
    <head>
        ...
        <style>
            ...
            html{
                ...
                .ml-2{margin-left:.5rem}.mt-4{margin-top:1rem}.ml-4{margin-left:1rem}.mt-8{margin-top:2rem}
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class=" fixed top-0 right-0 px-6 py-4 sm: block; form-group; social; d-flex; text-center">
                    @auth
                        <!-- <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 dark; text-gray-500 underline; ">Halaman Utama</a> -->
                    @else
                        <a href="{{ route('login') }}" class="px-2 py-2 mr-md-1 rounded; font-size: 10px">Login</a>
                        <!-- @if (Route::has('register'))
                        <a href="{{ route('register') }}" class=" px-2 py-2 mr-md-1 rounded">Register</a>
                        @endif -->
                    @endauth
                </div>
            @endif
    ...
    <div class="max-w-6xl mx-auto sm:px-4 lg:px-6">
        <div class="flex justify-center pt-8 sm:justify-start sm:pt-2">
            <div class="container px-4 px-lg-5; text-center">
                <img src="{{ url('/img/logomi.png') }}">
                <h1 class="mb-1 text-white font-weight-bold"  style="font-family:serif">TOKO AL HIDAYAH</h1>
                <h3 class="mb-5 text-white font-weight-bold"  style="font-family:serif"><em>Aplikasi penunjang pelaksanaan bisnis pertokoan Yayasan Al Hidayah, menyediakan berbagai produk dengan harga yang terjangkau.</em></h3>
            </div>
        </div>
    </div>
    </body>
